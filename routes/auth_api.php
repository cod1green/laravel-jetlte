...
use App\Http\Controllers\Api\{AddressApiController, FormPaymentApiController, TableApiController};
...
Route::prefix('v1')
    ->group(
        function () {
            Route::apiResource('users/addresses', AddressApiController::class)->middleware(['auth']);
