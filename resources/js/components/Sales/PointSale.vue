        ...
        <div class="row">
            <div class="col-md-6 p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button v-if="order.products.length > 0 && client.length != ''"
            ...
            <div class="col-md-6">
                <div class="input-group col-md-12 mb-3 mt-4 mt-md-0">
                    <input v-model="search" class="form-control"
                           placeholder="Pesquise pelo nome, codigo ou descrição do produto" type="text"
                           @keyup="getProducts()">
                </div>

                <ul class="products-list product-list-in-card pl-2 pr-2">
                    <li v-for="(product, index) in products.data" :key="index" class="item"
                        data-target="#staticBackdrop"
                        data-toggle="modal" @click.prevent="openDetailProduct(product, 'add')"
                    >
                        <div class="product-img">
                            <img v-if="product.image" :alt='product.title' :src="product.image">
                            <img v-else :alt='product.title' src="/images/company_none.png">
                        </div>
