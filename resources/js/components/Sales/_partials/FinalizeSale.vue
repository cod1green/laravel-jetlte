<template>
<div id="staticBackdropSale" aria-hidden="true" aria-labelledby="staticBackdropSaleLabel" class="modal fade"
     data-backdrop="static" data-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="staticBackdropSaleLabel" class="modal-title">Finalizar venda</h5>
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="input-group input-group-prepend">
                                        <div
                                            class="btn btn-outline-secondary input-group-prepend custom-control custom-switch pl-5">
                                            <input id="mode" class="custom-control-input" type="checkbox"
                                                   @click="isDelivery">
                                            <label class="custom-control-label" for="mode">Entrega</label>
                                        </div>

                                        <autocomplete v-show="delivery" :baseClass="'form-control'"
                                ...
                                <div class="form-row mt-md-3">
                                    ...
                                    <div class="input-group col-md-5">
                                        ...
                                        <money v-model="order.total_discount" v-bind="money" class="form-control"
                                               @keyup.native="amountPaid"></money>
                                    </div>
                                </div>
                                ...
                                <div class="form-row mt-md-3">
                                    <div class="input-group col-md-6">
                                        ...
                                        <money v-model="order.shipping" v-bind="money" class="form-control"
                                               @keyup.native="amountPaid"></money>
                                    </div>
                                    ...
                                    <div class="input-group mt-md-3 col-md-12">
                                        <textarea v-model="order.comment" class="form-control"
                                                  placeholder="Observações: massa fina, sem cebola, etc"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="card mt-md-3 p-md-0">
                                    ...
                                    <div class="card-body table-responsive p-md-0" style="height: 200px;">
                                        <table
                                            class="table table-sm table-condensed table-dark table-striped table-hover table-borderless align-middle table-head-fixed">
                                            <thead>
                                            <tr>
                                                <th>Produtos</th>
                                                <th>Preço</th>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <address class="col-12">
                                    <textarea v-model="address" class="form-control" @keyup="confirmAddress"></textarea>
                        ...
                        <div class="row justify-content-center">
                            <button class="col-md-3 btn btn-secondary mr-1" data-dismiss="modal" type="button">
                                <i class="fas fa-chevron-circle-left"></i> Voltar
                            </button>

                            <button v-if="validateFields" class="col-md-8 btn btn-success btn-block float-right"
                                    type="button" @click="confirmOrder">
                                <i class="far fa-credit-card"></i> Finalizar Venda
                            </button>
                            <button v-else class="col-md-8 btn btn-success btn-block float-right" disabled
                                    type="button">
                                <i class="far fa-credit-card"></i> Finalizar Venda
                            </button>
                        </div>
